...
export function buildSecretsPatch(activeModal: ActiveModal, form: ModalState): SecretsWrite {
  ...
  if (activeModal.id === "openai" && form.apiKey.trim()) patch.openai = { apiKey: form.apiKey.trim() };
  if (activeModal.id === "google" && form.apiKey.trim()) patch.google = { apiKey: form.apiKey.trim() };
