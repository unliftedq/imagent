...
export const en = {
  ...
  "gallery.toast.audioAssetUnsupportedDesc":
    "Audio library items can be remixed or added to boards, but reference assets are image-based today.",
  ...
  "studio.audio.codec": "Format",
  "studio.audio.formatQuality": "Quality",
