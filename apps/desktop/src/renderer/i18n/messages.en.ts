...
export const en = {
  ...
  "common.copyImageFailed": "Could not copy image",
  ...
  "common.image": "Image",
  "common.video": "Video",
  "common.speech": "Speech",
  "common.imagePlusVideo": "Image + Video",
  "common.imagePlusSpeech": "Image + Speech",
  "common.videoPlusSpeech": "Video + Speech",
  "common.imagePlusVideoPlusSpeech": "Image + Video + Speech",
  "common.other": "Other",
  ...
  "gallery.bulk.selectAll": "Select all",
  "gallery.bulk.selectItem": "Select item",
  "gallery.bulk.deselectItem": "Deselect item",
  "gallery.bulk.selected": "{count} selected",
  "gallery.bulk.clearSelection": "Clear selection",
  "gallery.bulk.favorite": "Toggle favorite",
  "gallery.bulk.addToBoard": "Add to board",
  "gallery.bulk.favoriteSuccess": "Favorites updated",
  "gallery.bulk.favoriteFailed": "Could not update favorites",
  "gallery.bulk.addedToBoard": "Added to board",
  "gallery.bulk.addToBoardFailed": "Could not add all items to board",
  "gallery.bulk.deleted": "Items deleted",
  "gallery.bulk.deleteFailed": "Could not delete all items",
  "gallery.bulk.failedDescription": "{count} item(s) could not be updated.",
  ...
  "gallery.empty.board.body": "Drag any library item onto this board from the All view.",
  "gallery.empty.all.title": "Your library is quiet",
  "gallery.empty.all.body":
    "Generated images, videos, and speech will collect here. Open Studio to create the first one — every item is searchable and remixable later.",
  ...
  "gallery.toast.speechAssetUnsupported": "Speech assets are not supported yet",
  "gallery.toast.speechAssetUnsupportedDesc":
    "Speech library items can be remixed or added to boards, but reference assets are image-based today.",
  ...
  "gallery.preview.saveAsAssetTooltip": "Save this library item as a reusable reference.",
  ...
  "gallery.preview.title": "Library item preview",
  ...
  "studio.speech.placeholder": "Enter the text you want to turn into speech",
  "studio.speech.generate": "Generate speech",
  "studio.speech.config": "Speech configuration",
  "studio.speech.voice": "Voice",
  "studio.speech.voicePreview": "Preview voice",
  "studio.speech.voiceStop": "Stop preview",
  "studio.speech.speed": "Speed",
  "studio.speech.outputFormat": "Output format",
  "studio.speech.codec": "Format",
  "studio.speech.formatQuality": "Quality",
  "studio.speech.extraKnobs": "Extra controls",
  "studio.speech.missingFields": "Enter text and choose a speech model first.",
  "studio.speech.submitFailed": "Speech submission failed",
  "studio.speech.couldNotLoadModels": "Could not load speech models",
  "studio.speech.noProvider": "No speech provider connected",
  "studio.speech.noProviderDesc":
    "Connect ElevenLabs, MiniMax, or another TTS provider to generate speech.",
  "studio.speech.emptyCanvasHint": "Generate speech to preview it here.",
  ...
  "studio.galleryReferenceAdded": "Added library image as reference",
  ...
  "studio.editJobAria": "Edit and reuse settings from job: {prompt}",
  "studio.filterNewest": "Newest",
  "studio.emptyGalleryRail": "No items yet — generate something to see it here.",
  "studio.viewAllGallery": "View all library",
  ...
  "studio.pickFromGallery": "Pick from library",
  ...
  "assets.dialog.galleryDesc": "Save this library item as a reusable reference.",
  ...
  "assets.galleryReferenceAttached": "Library reference attached. Drop or browse to replace.",
  ...
  "models.noSpeechModels": "No speech models in the catalog.",
