...
import { createPathResolver, type PathResolver } from "@imagine-studio/persistence";

/**
 * Resolves the on-disk paths for the Electron app. We prefer `~/.imagine-studio/`
...
export function createDesktopPathResolver(): PathResolver {
  ...
  return createPathResolver(path.join(home, ".imagine-studio"));
}
